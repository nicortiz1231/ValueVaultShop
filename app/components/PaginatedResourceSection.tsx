...
const pagerLink =
  'inline-flex h-11 items-center justify-center rounded-pill border border-line-strong bg-paper px-6 text-sm font-semibold text-ink transition-colors hover:bg-cream-deep';
